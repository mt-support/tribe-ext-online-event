...
$onlineTab = array(
	...
	'fields'   => array(
		...
		'eventsOnlineFieldHelperTitle' => array(
			'type' => 'html',
			'html' => '<h3>' . __( 'Online Event Field - from Additional Fields', 'tribe-ext-online-events' ) . '</h3>',
		),
		'eventsOnlineField'          => array(
			'type'            => 'dropdown',
			'label'           => __( 'Field that contains Event link', 'tribe-ext-online-events' ),
			'default'         => false,
			'validation_type' => 'options',
			'options'         => $fields,
		...
		'eventsOnlineFieldHelperEmail' => array(
			'type' => 'html',
			'html' => '<h3>' . __( 'Email options', 'tribe-ext-online-events' ) . '</h3>',
		),
		'eventsOnlineHeading' => array(
			'type'            => 'text',
